...
export default function Feature (){
    return(
        ...
        <div className="mt-12 sm:mt-16 md:mt-40 flex flex-col items-center gap-10">
            <TextDescription title="The Compound Effect of Unified Intelligence" styles="text-center whitespace-normal break-words leading-tight px-4  max-w-4xl mx-auto"></TextDescription>
